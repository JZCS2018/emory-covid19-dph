...
export default function StateMap(props) {
    ...
    const varGraphPair = {
        ...
        "casescum14dayR": { "name": ['casesdailyR', 'casesdailymean7RR'], "legend": ['Last 14 days cases per 100,000', '7-d rolling average'] }
    };
        ...
        return (
            <div
                ...
                <div>
                    ...
                    >
                        <Grid column={2} style={{ paddingTop: '4em', paddingLeft: '0em', paddingBottom: '2em', width: "1260px" }} divided>
                            <Grid.Column width={5}>
                                <Grid.Row>
                            ...
                            <Grid.Column width={11}>
                                <Header as='h2' style={{
                                    ...
                                    The Georgia COVID-19 Health Equity dashboard is a tool to dynamically track and compare the burden of cases and deaths across the counties in Georgia.
                                        ...
                                        and decision making by county health officials and individual residents. Additional information on the data used on this website can be found <u>here</u>.
                            ...
                            <Grid stackable columns={3} style={{ width: "100%", height: "100%" }} >
                                ...
                                <Grid.Column width={16} style={{ width: "100%", height: "100%" }}>
                                    ...
                                    <Grid.Row>
                                            ...
                                            <Header as='h2' style={{ textAlign: 'center', color: 'black', fontSize: "22pt", paddingLeft: '1em', paddingTop: '1em', paddingBottom: '1em' }}>
                                                <Header.Content>
                                    ...
                                    <Grid columns={2} style={{ paddingBottom: '3em' }}>
                                            ...
                                            <Grid.Column width={16}>
                                                <Header as='h2' style={{ fontFamily: 'lato', fontSize: "16px", paddingRight: 0, color: '#414042' }}>
                                                    <Header.Content>
                                                        ...
                                                        <Header.Subheader style={{ fontFamily: 'lato', fontSize: "16px", paddingRight: 0, color: '#414042' }}>Select an indicator from the dropdown menu:</Header.Subheader>
                                                    </Header.Content>
                                                </Header>
                                            </Grid.Column>
                                        </Grid.Row>
                                        <Grid.Column width={7} style={{ paddingLeft: "2", paddingLeft: "1" }}>
                                            ...
                                            <SvgMap name={metric}
                                                ...
                                                legendMax={legendMax}
                                            />
                                            <Header.Subheader style={{paddingLeft:'1em', fontFamily: 'lato', fontSize: "10pt", paddingTop: 1, color: '#4e52c8' }}>
                                                        Click map below to see county-level data.
                                        </Header.Subheader>
                                            <ComposableMap projection="geoAlbersUsa"
                                                data-tip='ga' data-for='ga'
                                                    ...
                                                    content: {
                                                      content: (
                                                        ...
                                                        {/* <Popup
                                                            ...
                                                            trigger={<Button content='Description of Graph' />}><p style={{ fontFamily: 'lato', fontSize: 18 }}>
                                                                This chart shows the daily number of new confirmed COVID-19 {varNameMap[metric].name} in <b>{countyName}</b> as of {covidMetric.t === 'n/a' ? 'N/A' :
                                                                    (new Date(covidMetric.t * 1000).toLocaleDateString('en-Us', { month: 'short', day: 'numeric', year: 'numeric' }))}. The daily number reflects the date the {varNameMap[metric].cat} was first reported to DPH.
                        The vertical bars show the number of new daily {varNameMap[metric].name} while the line shows the 7-day moving average of new daily {varNameMap[metric].name}.</p>
                                                        </Popup> */}
                                        ...
                                        <Grid style={{ paddingLeft: "7em", paddingTop: '0.5em', paddingRight: "7em", width: "100%", height: "100%" }}>
                                            <Grid.Row columns={2} style={{ paddingTop: 11 }}>
                                                <Grid.Column style={{ paddingTop: '1em', paddingBottom: 18 }}>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <VictoryBar
                                                                alignment="start"
                                                                barWidth={20}
                                                                labels={({ datum }) => `Percentage of Cases: ${(datum.value * 100).toFixed(2)}%`}
                                                    ...
                                                    <Grid.Row style={{ paddingTop: '0.5em', paddingLeft: '4em', paddingRight: '2em' }} centered>
                                                <p style ={{fontFamily: 'lato', fontSize: 18, color:dataupColor, paddingLeft:'0.5em'}}>
                                                    Data updated: {dateCur[stateFips + countyFips].todaydate === 'n/a' ? 'N/A' : (new Date(dateCur[stateFips + countyFips].todaydate * 1000).toLocaleDateString('en-Us', { month: 'short', day: 'numeric', year: 'numeric' }))}
                                                </p>
                                            <Accordion defaultActiveIndex={1} panels={[
...
<br />
                                            ...
                                            <Grid.Column width={9} style={{ paddingLeft: "2", paddingLeft: "1" }}>
                                                ...
                                                {/* <Grid.Row style={{ paddingTop: '0.1em', paddingLeft: '2.9em', paddingRight: '0.1em' }} centered>
                                                    <small style={{ fontFamily: 'lato', fontSize: 18, color: '#414042' }} align="justify">
                                                        This chart shows the number of COVID-19 cases per 100,000 residents as of {dateCur[stateFips + countyFips].todaydate === 'n/a' ? 'N/A' :
                                                            (new Date(dateCur[stateFips + countyFips].todaydate * 1000).toLocaleDateString('en-Us', { month: 'short', day: 'numeric', year: 'numeric' }))} by CCVI ranking.
                                                ...
                                                <Grid.Row style={{ paddingTop: '3.5em', paddingLeft: '4em', paddingRight: '2em' }} centered>
                                                <p style ={{fontFamily: 'lato', fontSize: 18, color:dataupColor, paddingLeft:'0.5em'}}>
                                                    Data updated: {dateCur[stateFips + countyFips].todaydate === 'n/a' ? 'N/A' : (new Date(dateCur[stateFips + countyFips].todaydate * 1000).toLocaleDateString('en-Us', { month: 'short', day: 'numeric', year: 'numeric' }))}
                                                </p>
                                            <Accordion defaultActiveIndex={1} panels={[
                ...
                <br />
                                            ...
                                            <Grid.Column width={9} style={{ paddingLeft: "2", paddingLeft: "1" }}>
                                                ...
                                                <Grid.Row style={{ paddingTop: '0.1em', paddingLeft: '2.9em', paddingRight: '0.1em' }} centered>
                                                    <small style={{ fontFamily: 'lato', fontSize: 18, color: '#414042' }} align="justify">
                                                        This chart shows the number of COVID-19 cases per 100,000 residents as of {dateCur[stateFips + countyFips].todaydate === 'n/a' ? 'N/A' :
                                                            (new Date(dateCur[stateFips + countyFips].todaydate * 1000).toLocaleDateString('en-Us', { month: 'short', day: 'numeric', year: 'numeric' }))} by residential segregation index.
                                        ...
                                        <Grid id="black" >
                                            ...
                                            <Grid.Column width={7} style={{ paddingLeft: "2", paddingLeft: "1" }}>
                                                ...
                                                <Grid.Row data-tip='black' data-for='black' style={{ paddingTop: "0", paddingBottom: '1em' }}>
                                                    ...
                                                    {/* <svg width="600" height="80">
                                                        <rect key={0} x={50} y={0} width="20" height="20" style={{ fill: colorPalette[0], strokeWidth: 1, stroke: colorPalette[0] }} />
                                                        <text x={80} y={15} style={{ fontSize: '1em' }}>0 {'-'} 9.99</text>
                                                        <rect key={1} x={200} y={0} width="20" height="20" style={{ fill: colorPalette[1], strokeWidth: 1, stroke: colorPalette[1] }} />
                                                        <text x={230} y={15} style={{ fontSize: '1em' }}>9.99 {'-'} 23.45</text>
                                                        <rect key={2} x={360} y={0} width="20" height="20" style={{ fill: colorPalette[2], strokeWidth: 1, stroke: colorPalette[2] }} />
                                                        <text x={390} y={15} style={{ fontSize: '1em' }}>23.45 {'-'} 30.24</text>

                                                        <rect key={3} x={130} y={40} width="20" height="20" style={{ fill: colorPalette[3], strokeWidth: 1, stroke: colorPalette[3] }} />
                                                        <text x={160} y={55} style={{ fontSize: '1em' }}>30.24 {'-'} 41.94</text>
                                                        <rect key={4} x={280} y={40} width="20" height="20" style={{ fill: colorPalette[4], strokeWidth: 1, stroke: colorPalette[4] }} />
                                                        <text x={310} y={55} style={{ fontSize: '1em' }}>41.94 {'+'}</text>
