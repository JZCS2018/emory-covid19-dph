            ...
            <Breadcrumb.Divider /> */}
                    ...
                    <Header.Subheader style={{ fontWeight: 300 }}></Header.Subheader>
                        ...
                        The vertical bars show the number of new daily {varNameMap[metric].name} while the line shows the 7-day moving average of new daily {varNameMap[metric].name}.
                            ...
                            onEnter={() => {
                                ++scrollCount;
                                console.log('The first part entered the view port!!!!!')
                                console.log('currCount!!!!!' + scrollCount)
                            }}
                            onLeave={() => {
                                --scrollCount;
                                console.log('The first part left the view port!!!!!')
                                console.log('currCount!!!!!' + scrollCount)
                            }}>
                                </Waypoint> </center>
                            ...
                            {/* <center> <Waypoint onEnter={() => {
                                currCount += 1;
                                setCount(currCount);
                                console.log('The second part entered the view port!!!!!')
